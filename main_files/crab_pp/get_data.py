...
"""
This file can be used to get the dataset from afs and bring it into the pyspi format. Also combine the SE and PE datasets.
It is designed to be used on necromancer. All data is safed within the data1 directory.
"""
...
def combine_datasets(path_1:str, path_2:str, new_path:str):
    ...
    **Warning**: This is not the correct way to combine the datasets. The livetime of the PE dataset is not corrected.
