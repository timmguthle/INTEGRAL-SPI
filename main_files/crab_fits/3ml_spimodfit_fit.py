...
# possible datasets
reduced_counts_Timm2 = ['/home/tguethle/Documents/spi/Master_Thesis/main_files/spimodfit_comparison_sim_source/reduced_counts_Timm2/low_energy', 'fit_Crab_374_reduced_bkg', [7e-4, -2]]
...
crab_fit_43_44_45 = ["/home/tguethle/Documents/spi/Master_Thesis/main_files/crab_fits/43_44_45_low_e", "fit_Crab_43_44_45_crab", [7e-4, -2]]

# only modify this line to change the dataset
dataset = reduced_counts_Timm2
...
def run_fit(channels: list[str], save_figure=False, source_name='sim_sourc'):
    """
...
if __name__ == '__main__':
    ...
    #val, cov, err, logL = run_fit(c_for_reduced, source_name='sim_sourc')
    val, cov, err, logL = run_fit_bayes(lowE, source_name='sim_sourc')
    #run_fit(lowE, source_name='sim_sourc')
    save_fit(val, cov)
    print(val, cov)
